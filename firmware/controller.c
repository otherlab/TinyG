...
const char* const msgStatusMessage[] PROGMEM = {
...
const const char msg_ap00[] PROGMEM = "<null message>";
const const char msg_ap01[] PROGMEM = "Loading configs from EEPROM";

const char * const msgApplicationMessage[] PROGMEM = {
	msg_ap00, msg_ap01
};
