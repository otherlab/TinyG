...
struct cfgItem {			// structs for pgmArray
	...
	const double *target;			// target for writing config value
	const double def_value;		// default value for config item
};
...
const char * const msg_units[] PROGMEM = { msg_units0, msg_units1, msg_units2 };

static const char msg_g20[] PROGMEM = "G20 - inches mode";
static const char msg_g21[] PROGMEM = "G21 - millimeter mode";
const char * const msg_unit[] PROGMEM = { msg_g20, msg_g21 };
...
const char * const msg_stat[] PROGMEM = { msg_stat0, msg_stat1, msg_stat2, msg_stat3 , msg_stat4 , msg_stat5 , msg_stat6 , msg_stat7 };
...
const char * const msg_cycs[] PROGMEM = { msg_cycs0, msg_cycs1, msg_cycs2, msg_cycs3 };

static const char msg_mots0[] PROGMEM = "Stop";
static const char msg_mots1[] PROGMEM = "Run";
static const char msg_mots2[] PROGMEM = "Hold";
const char * const msg_mots[] PROGMEM = { msg_mots0, msg_mots1, msg_mots2 };
...
const char * const msg_hold[] PROGMEM = { msg_hold0, msg_hold1, msg_hold2, msg_hold3, msg_hold4 };
...
const char * const msg_coor[] PROGMEM = { msg_g53, msg_g54, msg_g55, msg_g56, msg_g57, msg_g58, msg_g59 };
...
const char * const msg_momo[] PROGMEM = { msg_g00, msg_g01, msg_g02, msg_g03, msg_g80 };
...
const char * const msg_plan[] PROGMEM = { msg_g17, msg_g18, msg_g19 };
...
const char * const msg_path[] PROGMEM = { msg_g61, msg_g61, msg_g64 };
...
const char * const msg_dist[] PROGMEM = { msg_g90, msg_g91 };
...
const char * const msg_frmo[] PROGMEM = { msg_g94, msg_g93 };
...
const char * const msg_am[] PROGMEM = {
...
//const char str_ea[] PROGMEM = "ea,enable_a,[ea]  enable_acceleration%10d [0,1]\n";
